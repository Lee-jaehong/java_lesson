...
public class C09_Character {
	...
	public static void main(String[] args) {
		...
		// 문자코드 정수값 출력은 -> int로 캐스팅 : 둘다 97 출력
//		System.out.printf("c1 = %d\n", c1); 오류: char 형은 %d가 아닙니다.
		System.out.printf("c1 = %d\n", (int)c1);
