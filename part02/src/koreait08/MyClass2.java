...
public class MyClass2 {
	...
	//커스텀 생성자 정의 연습 : 생성자메소드 이름은 반드시 1)클래스 이름과 동일하게 2) 리턴타입은 없는 형식
	//                   3) 접근 한정자는 4가지 모두 가능 : 지금 예시는 기본 package
	//           목적 : 필드 초기화이고 연산식 또는 다른 명령문도 포함 가능
	MyClass2(String name){
		this.name=name;  //setter메소드처럼 전역변수(필드)값을 초기화.
	}
	...
	public String getName() { // setter는 생성자로 대체하고 getter만 있는 예시
