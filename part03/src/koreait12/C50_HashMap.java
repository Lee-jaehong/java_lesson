...
public class C50_HashMap {
	...
	public static void main(String[] args) {
		...
		System.out.println("'스파게티'의 가격은? " + menus.get("스파게티"));
		System.out.println("'스테이크'의 가격은? " + menus.get("스테이크"));
		System.out.println("'샐러드'의 가격은? " + menus.get("샐러드"));
...
HashMap : 순차적인 구조가 아닙니다. 인덱스를 사용하지 앖고 Key 값을 이용하여 데이터접근하여 저장/읽기 합니다.
  		...
  		(hashmap에서는 key,value 한쌍으로 요소가 됩니다.value를 검색하기 위해서 key를 사용합니다.)
