...
public class BinaryTest2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("16진수 리터럴 0xa41c: " + n16);		// 정수값 출력은 format 지정안하면 10진수로 출력
		...
		//결론 : 10진수 42012, n16과 n2 변수 값이 메모리에 저장 될 때는 모두 동일한 0,1 표현값입니다.
		...
		System.out.println("3. 입력한 2,16진수값을 10진수로 바꾸어 드립니다.");
		...
		System.out.println(String.format("2진수 %s는 10진수 %d입니다.", t2, 
										Integer.parseInt(t2, 2)));		//t2는 2진수 - > 메소드 결과 정수값
		System.out.println(String.format("16진수 %s는 10진수 %d입니다.", t16, 
										Integer.parseInt(t16, 16)));	//t16은 16진수 - > 메소드 결과 정수값
